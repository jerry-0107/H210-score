          ...
          <DialogContentText id="alert-dialog-description2">
            ...
            <p>以下是學生與家長專用的查詢連結:<br />
              <TextField type='text'
                InputProps={{
                  readOnly: true,
                }} sx={{ width: "100%" }} variant="standard" value={`https://H310-score-production.up.railway.app/score/?q=${UrlParam("q")}`} />
            </p>
            <p>以下是自動生成的描述:<br />
              <TextField
                multiline
